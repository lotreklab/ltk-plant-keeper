...
export default function DetailFromRetrieve({ navigation}: { navigation: any }) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ImageBackground
        source={{uri: suggestion?.similar_images[0].url}} // Replace with your image
      ...
      <View style={styles.coreContainer}>
        ...
        <View style={styles.cardTextBoxWrapper}>
          <View style={styles.cardTextBox}>
            ...
            <Text style={styles.cardSubtitle}>{details.taxonomy.genus}</Text>
          </View>

          <View style={styles.cardTextBox}>
            <Text style={styles.cardTags}>Family</Text>
            <Text style={styles.cardSubtitle}>{details.taxonomy.family}</Text>
          </View>
        </View>
